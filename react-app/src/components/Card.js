    ...
    // } else {
        return (
            <div>
                ...
                {gameState.player1CardInfo && <img className='player-card-image' src={getCardSymbol(gameState.player1CardInfo)} alt='broken'></img>}
                {gameState.player2CardInfo && <img className='player-card-image' src={getCardSymbol(gameState.player2CardInfo)} alt='broken'></img>}
            </div>
        );
    };
// };
